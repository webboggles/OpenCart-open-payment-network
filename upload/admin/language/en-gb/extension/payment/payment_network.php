...
// placeholders
$_['text_merchantid']                   = "Enter the merchant ID provided by Payment Network MMS, use merchant_id_here for testing";
$_['text_merchantsecret']               = "Enter the merchant secret provided by Payment Network MMS, use merchant_secret_here for testing";
$_['text_merchant_country_code']        = "Enter the Merchant country code";
$_['text_gateway_url']                  = "Enter the Gateway Url";

// Entrys
$_['entry_merchantid']                  = 'Merchant ID:';
$_['entry_merchantsecret']              = 'Merchant Secret:';
$_['entry_merchant_country_code']       = 'Merchant Country Code:';
...
$_['error_msg_merchant_country_code']   = 'Merchant country code is required';
